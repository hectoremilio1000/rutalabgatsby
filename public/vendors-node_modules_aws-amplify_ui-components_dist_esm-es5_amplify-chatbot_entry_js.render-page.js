exports.id = "vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_amplify-chatbot_entry_js";
exports.ids = ["vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_amplify-chatbot_entry_js"];
exports.modules = {
...
/* harmony import */ var _aws_amplify_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @aws-amplify/core */ "./node_modules/@aws-amplify/core/lib-esm/JS.js");
...
/* harmony import */ var _aws_amplify_interactions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @aws-amplify/interactions */ "./node_modules/@aws-amplify/interactions/lib-esm/Interactions.js");
...
var logger = new _aws_amplify_core__WEBPACK_IMPORTED_MODULE_3__.ConsoleLogger('AudioRecorder');
    ...
    AudioRecorder.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(0,_aws_amplify_core__WEBPACK_IMPORTED_MODULE_4__.browserOrNode)().isBrowser) return [3 /*break*/, 2];
                        window.AudioContext =
...
var visualize = function (dataArray, bufferLength, canvas) {
    if (!canvas)
        return;
    if (!(0,_aws_amplify_core__WEBPACK_IMPORTED_MODULE_4__.browserOrNode)().isBrowser)
...
var AmplifyChatbot = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.botTitle = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.CHATBOT_TITLE;
    ...
    class_1.prototype.componentWillLoad = function () {
        if (!_aws_amplify_interactions__WEBPACK_IMPORTED_MODULE_5__.Interactions || typeof _aws_amplify_interactions__WEBPACK_IMPORTED_MODULE_5__.Interactions.onComplete !== 'function') {
            throw new Error(_constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.d);
        }
        this.validateProps();
    };
    ...
    class_1.prototype.validateProps = function () {
        ...
        if (!this.voiceEnabled && !this.textEnabled) {
            this.setError(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.CHAT_DISABLED_ERROR, ChatErrorType.Unrecoverable);
            return;
        }
        else if (!this.botName) {
            this.setError(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.NO_BOT_NAME_ERROR, ChatErrorType.Unrecoverable);
            return;
        }
    ...
    class_1.prototype.footerJSX = function () {
        ...
        var inputPlaceholder = this.textEnabled
            ? _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.TEXT_INPUT_PLACEHOLDER
            : _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.VOICE_INPUT_PLACEHOLDER;
        var textInput = ((0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-input", { placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_6__.I18n.get(inputPlaceholder), description: "text", handleInputChange: function (evt) { return _this.handleTextChange(evt); }, value: this.text, disabled: this.chatState === ChatState.Error || !this.textEnabled }));
...
;
//# sourceMappingURL=vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_amplify-chatbot_entry_js.render-page.js.map