exports.id = "vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_amplify-confirm-sign-in_7_entry_js";
exports.ids = ["vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_amplify-confirm-sign-in_7_entry_js"];
exports.modules = {
...
/* harmony import */ var _auth_helpers_c05e889e_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./auth-helpers-c05e889e.js */ "./node_modules/@aws-amplify/ui-components/dist/esm-es5/auth-helpers-c05e889e.js");
...
var AmplifyConfirmSignIn = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.headerText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SMS_CODE;
        /** Used for the submit button text in confirm sign in component */
        this.submitButtonText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM;
        /** Auth state change handler for this component */
        this.handleAuthStateChange = _helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.d;
        /**
    ...
    class_1.prototype.setup = function () {
        if (this.user &&
            ...
            if (this.headerText === _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SMS_CODE) {
                this.headerText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_TOTP_CODE;
            }
        }
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, (0,_auth_helpers_c05e889e_js__WEBPACK_IMPORTED_MODULE_5__.c)(this.user, this.handleAuthStateChange)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 4:
                        error_1 = _a.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_1);
                        return [3 /*break*/, 6];
                    case 5:
                        this.loading = false;
                        return [7 /*endfinally*/];
...
var AmplifyConfirmSignUp = /** @class */ (function () {
    function class_2(hostRef) {
        ...
        this.headerText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SIGN_UP_HEADER_TEXT;
        /** Used for the submit button text in confirm sign up component */
        this.submitButtonText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SIGN_UP_SUBMIT_BUTTON_TEXT;
        /**
         * Form fields allows you to utilize our pre-built components such as username field, code field, password field, email field, etc.
         * by passing an array of strings that you would like the order of the form to be in. If you need more customization, such as changing
         * text for a label or adjust a placeholder, you can follow the structure below in order to do just that.
    ...
    class_2.prototype.setup = function () {
        ...
        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.c)(this.usernameAlias);
        this.buildFormFields();
    };
    class_2.prototype.buildDefaultFormFields = function () {
        ...
        this.newFormFields = [
            ...
            {
                type: 'code',
                label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SIGN_UP_CODE_LABEL),
                placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SIGN_UP_CODE_PLACEHOLDER),
                required: true,
                hint: ((0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SIGN_UP_LOST_CODE), ' ', (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-button", { variant: "anchor", onClick: function () { return _this.resendConfirmCode(); } }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SIGN_UP_RESEND_CODE)))),
        ...
        if (this.formFields.length === 0) {
            ...
            this.formFields.forEach(function (field) {
                ...
                if (newField.type === 'code') {
                    newField['hint'] = (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.i)(newField) ? ((0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SIGN_UP_LOST_CODE), ' ', (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-button", { variant: "anchor", onClick: function () { return _this.resendConfirmCode(); } }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SIGN_UP_RESEND_CODE)))) : (newField['hint']);
                }
    ...
    class_2.prototype.handleFormFieldInputChange = function (fieldType) {
        ...
        switch (fieldType) {
            ...
            case 'phone_number':
                return function (event) { return (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.h)(event, _this.phoneNumber); };
            case 'code':
    ...
    class_2.prototype.getUsername = function () {
        ...
        switch (this.usernameAlias) {
            ...
            case 'phone_number':
                return (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.b)(this.phoneNumber);
        }
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!username)
                            throw new Error(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.EMPTY_USERNAME);
                    ...
                    case 3:
                        error_2 = _a.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_2);
                        return [3 /*break*/, 4];
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!confirmSignUpResult) {
                            throw new Error(_aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CONFIRM_SIGN_UP_FAILED));
                        }
                        ...
                        return [4 /*yield*/, (0,_auth_helpers_c05e889e_js__WEBPACK_IMPORTED_MODULE_5__.h)(username, this._signUpAttrs.password, this.handleAuthStateChange)];
                    case 3:
                        // Auto sign in user if password is available from previous workflow
                        _a.sent();
                        return [3 /*break*/, 5];
                    ...
                    case 6:
                        error_3 = _a.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_3);
                        return [3 /*break*/, 8];
                    case 7:
                        this.loading = false;
                        return [7 /*endfinally*/];
...
var AmplifyForgotPassword = /** @class */ (function () {
    function class_3(hostRef) {
        ...
        this.headerText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.RESET_YOUR_PASSWORD;
        /** The text displayed inside of the send code button for the form */
        this.sendButtonText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SEND_CODE;
        /** The text displayed inside of the submit button for the form */
        this.submitButtonText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SUBMIT;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        switch (this.usernameAlias) {
                            case 'phone_number':
                                try {
                                    this.forgotPasswordAttrs.userInput = (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.b)(this.phoneNumber);
                                }
                                catch (error) {
                                    (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error);
                                }
                                break;
                        }
                        _a.label = 1;
                    ...
                    case 2:
                        ...
                        this.newFormFields = [
                            ...
                            },
                            {
                                ...
                                label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.NEW_PASSWORD_LABEL),
                                placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.NEW_PASSWORD_PLACEHOLDER),
                            },
                        ];
                    ...
                    case 3:
                        error_4 = _a.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_4);
                        return [3 /*break*/, 5];
                    case 4:
                        this.loading = false;
                        return [7 /*endfinally*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        error_5 = _b.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_5);
                        return [3 /*break*/, 5];
                    case 4:
                        this.loading = false;
                        return [7 /*endfinally*/];
...
var AmplifyRequireNewPassword = /** @class */ (function () {
    function class_4(hostRef) {
        ...
        (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
        /** The header text of the forgot password section */
        this.headerText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CHANGE_PASSWORD;
        /** The text displayed inside of the submit button for the form */
        this.submitButtonText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CHANGE_PASSWORD_ACTION;
        /** The function called when submitting a new password */
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_6 = _a.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_6);
                        return [3 /*break*/, 4];
                    ...
                    case 6:
                        if (this.currentUser &&
                            ...
                            userRequiredAttributes = this.currentUser.challengeParam
                                .requiredAttributes;
                            requiredAttributesMap_1 = (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.g)();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, (0,_auth_helpers_c05e889e_js__WEBPACK_IMPORTED_MODULE_5__.c)(user, this.handleAuthStateChange)];
                    case 6:
                        _b.sent();
                        _b.label = 7;
                    ...
                    case 8:
                        error_7 = _b.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_7);
                        return [3 /*break*/, 10];
                    case 9:
                        this.loading = false;
                        return [7 /*endfinally*/];
...
var AmplifySignIn = /** @class */ (function () {
    function class_5(hostRef) {
        ...
        this.headerText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_IN_HEADER_TEXT;
        /** Used for the submit button text in sign in component */
        this.submitButtonText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_IN_ACTION;
        /** Auth state change handler for this component */
        // prettier-ignore
        this.handleAuthStateChange = _helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.d;
        /** Username Alias is used to setup authentication with `username`, `email` or `phone_number`  */
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        switch (this.usernameAlias) {
                            case 'phone_number':
                                try {
                                    this.signInAttributes.userInput = (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.b)(this.phoneNumber);
                                }
                                catch (error) {
                                    (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error);
                                }
                        ...
                        return [4 /*yield*/, (0,_auth_helpers_c05e889e_js__WEBPACK_IMPORTED_MODULE_5__.h)(username, this.signInAttributes.password, this.handleAuthStateChange)];
                    case 1:
                        _a.sent();
                        this.loading = false;
                        return [2 /*return*/];
    ...
    class_5.prototype.buildDefaultFormFields = function () {
        ...
        formFieldInputs.push({
            type: 'password',
            hint: ((0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.FORGOT_PASSWORD_TEXT), ' ', (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-button", { variant: "anchor", onClick: function () { return _this.handleAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_1__.A.ForgotPassword); }, "data-test": "sign-in-forgot-password-link" }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.RESET_PASSWORD_TEXT)))),
            required: true,
            handleInputChange: this.handleFormFieldInputChange('password'),
            inputProps: {
...
var AmplifySignUp = /** @class */ (function () {
    function class_6(hostRef) {
        ...
        this.headerText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_UP_HEADER_TEXT;
        /** Used for the submit button text in sign up component */
        this.submitButtonText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_UP_SUBMIT_BUTTON_TEXT;
        /** Used for the submit button text in sign up component */
        this.haveAccountText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_UP_HAVE_ACCOUNT_TEXT;
        /** Text used for the sign in hyperlink */
        this.signInText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_IN_TEXT;
        /**
         * Form fields allows you to utilize our pre-built components such as username field, code field, password field, email field, etc.
         * by passing an array of strings that you would like the order of the form to be in. If you need more customization, such as changing
         * text for a label or adjust a placeholder, you can follow the structure below in order to do just that.
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.phoneNumber.phoneNumberValue) {
                            try {
                                this.signUpAttributes.attributes.phone_number = (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.b)(this.phoneNumber);
                            }
                            catch (error) {
                                (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error);
                            }
                    ...
                    case 1:
                        ...
                        if (this.signUpAttributes.username.indexOf(' ') >= 0) {
                            throw new Error(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.USERNAME_REMOVE_WHITESPACE);
                        }
                        if (this.signUpAttributes.password !== this.signUpAttributes.password.trim()) {
                            throw new Error(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.PASSWORD_REMOVE_WHITESPACE);
                        }
                        return [4 /*yield*/, _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_6__.Auth.signUp(this.signUpAttributes)];
                    case 2:
                        data = _a.sent();
                        if (!data) {
                            throw new Error(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_UP_FAILED);
                        }
                        if (!data.userConfirmed) return [3 /*break*/, 4];
                        return [4 /*yield*/, (0,_auth_helpers_c05e889e_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.signUpAttributes.username, this.signUpAttributes.password, this.handleAuthStateChange)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
                    ...
                    case 6:
                        error_8 = _a.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_8);
                        return [3 /*break*/, 8];
                    case 7:
                        this.loading = false;
                        return [7 /*endfinally*/];
        ...
        switch (this.usernameAlias) {
            case 'email':
                this.newFormFields = [
                    {
                        type: 'email',
                        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_UP_EMAIL_PLACEHOLDER),
                        required: true,
                        handleInputChange: this.handleFormFieldInputChange('email'),
                        inputProps: {
                    ...
                    {
                        type: 'password',
                        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_UP_PASSWORD_PLACEHOLDER),
                        required: true,
                        handleInputChange: this.handleFormFieldInputChange('password'),
                        inputProps: {
            ...
            default:
                this.newFormFields = [
                    {
                        type: 'username',
                        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.SIGN_UP_USERNAME_PLACEHOLDER),
                        required: true,
                        handleInputChange: this.handleFormFieldInputChange('username'),
                        inputProps: {
...
var AmplifyVerifyContact = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_9 = _a.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_9);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_10 = _a.sent();
                        (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_4__.a)(error_10);
    ...
    class_7.prototype.renderSubmit = function () {
        ...
        return ((0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-input", { inputProps: {
            ...
            }, name: "code", placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.CODE_PLACEHOLDER), handleInputChange: function (event) { return _this.handleInputChange(event); } })));
    };
    ...
    class_7.prototype.render = function () {
        var _this = this;
        return ((0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-form-section", { handleSubmit: function (event) { return _this.handleSubmit(event); }, headerText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.VERIFY_CONTACT_HEADER_TEXT), loading: this.loading, secondaryFooterContent: (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-button", { variant: "anchor", onClick: function () { return _this.handleAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_1__.A.SignedIn, _this.user); }, "data-test": "verify-contact-skip-link" }, "Skip")), submitButtonText: this.verifyAttr
                ? _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.VERIFY_CONTACT_SUBMIT_LABEL)
                : _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.VERIFY_CONTACT_VERIFY_LABEL) }, this.verifyAttr ? this.renderSubmit() : this.renderVerify())));
    };
    return class_7;
}());
...
/***/ "./node_modules/@aws-amplify/ui-components/dist/esm-es5/auth-helpers-c05e889e.js":
/*!***************************************************************************************!*\
  !*** ./node_modules/@aws-amplify/ui-components/dist/esm-es5/auth-helpers-c05e889e.js ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @aws-amplify/auth */ "./node_modules/amazon-cognito-identity-js/es/index.js");
/* harmony import */ var _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Translations-c833f663.js */ "./node_modules/@aws-amplify/ui-components/dist/esm-es5/Translations-c833f663.js");
...
/* harmony import */ var _helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers-82822fb2.js */ "./node_modules/@aws-amplify/ui-components/dist/esm-es5/helpers-82822fb2.js");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        ...
        switch (_a.label) {
            ...
            case 9:
                ...
                if (error_2.code === 'UserNotConfirmedException') {
                    ...
                    error_2.message = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.EMPTY_PASSWORD;
                }
                (0,_helpers_82822fb2_js__WEBPACK_IMPORTED_MODULE_3__.a)(error_2);
                return [3 /*break*/, 10];
            case 10: return [2 /*return*/];
        }
    });
...
var isCognitoUser = function (user) {
    return user instanceof _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_7__.CognitoUser;
};
...
;
//# sourceMappingURL=vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_amplify-confirm-sign-in_7_entry_js.render-page.js.map