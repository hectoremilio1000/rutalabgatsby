exports.id = "vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_amplify-s3-album_entry_js";
exports.ids = ["vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_amplify-s3-album_entry_js"];
exports.modules = {
...
var AmplifyS3Album = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.picker = true;
        /** Picker button text */
        this.pickerText = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_2__.T.PICKER_TEXT;
        this.albumItems = [];
        this.imgArr = {};
        ...
        this.marshal = function (list) {
            list.forEach(function (item) {
                ...
                if (_storage_helpers_48c373a0_js__WEBPACK_IMPORTED_MODULE_5__.i.has(ext)) {
                    if (!item.contentType ||
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        key = path + (0,_storage_helpers_48c373a0_js__WEBPACK_IMPORTED_MODULE_5__.c)(file, fileToKey);
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, (0,_storage_helpers_48c373a0_js__WEBPACK_IMPORTED_MODULE_5__.p)(key, file, level, track, file['type'], logger)];
                    case 2:
                        _c.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return ((0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "album-container" }, (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "grid-row" }, this.albumItems.map(function (item) {
            return ((0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "grid-item", key: "key-" + item.key }, (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-s3-image", { key: _this.imgArr[item.key], imgKey: item.key, level: _this.level, path: _this.path, identityId: _this.identityId, track: _this.track, handleOnError: _this.handleOnError, handleOnLoad: _this.handleOnLoad }), (0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "img-overlay" })));
        }))), this.picker && ((0,_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-picker", { pickerText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_8__.I18n.get(this.pickerText), inputHandler: function (e) { return _this.handlePick(e); }, acceptValue: "image/*" }))));
    };
    return class_1;
}());
...
;
//# sourceMappingURL=vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_amplify-s3-album_entry_js.render-page.js.map