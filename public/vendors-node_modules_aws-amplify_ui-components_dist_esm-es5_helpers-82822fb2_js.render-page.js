exports.id = "vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_helpers-82822fb2_js";
exports.ids = ["vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_helpers-82822fb2_js"];
exports.modules = {
...
/***/ "./node_modules/@aws-amplify/ui-components/dist/esm-es5/helpers-82822fb2.js":
/*!**********************************************************************************!*\
  !*** ./node_modules/@aws-amplify/ui-components/dist/esm-es5/helpers-82822fb2.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "a": () => (/* binding */ dispatchToastHubEvent),
/* harmony export */   "b": () => (/* binding */ composePhoneNumberInput),
/* harmony export */   "c": () => (/* binding */ checkUsernameAlias),
/* harmony export */   "d": () => (/* binding */ dispatchAuthStateChangeEvent),
/* harmony export */   "e": () => (/* binding */ closestElement),
/* harmony export */   "g": () => (/* binding */ getRequiredAttributesMap),
/* harmony export */   "h": () => (/* binding */ handlePhoneNumberChange),
/* harmony export */   "i": () => (/* binding */ isHintValid),
/* harmony export */   "o": () => (/* binding */ onAuthUIStateChange)
/* harmony export */ });
...
/* harmony import */ var _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @aws-amplify/core */ "./node_modules/@aws-amplify/core/lib-esm/I18n/index.js");
...
var logger = new _aws_amplify_core__WEBPACK_IMPORTED_MODULE_3__.ConsoleLogger('helpers');
/**
...
var dispatchToastHubEvent = function (error) {
    _aws_amplify_core__WEBPACK_IMPORTED_MODULE_4__.Hub.dispatch(_constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.U, {
        event: _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.T,
        message: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(error.message),
    });
};
var dispatchAuthStateChangeEvent = function (nextAuthState, data) {
    _aws_amplify_core__WEBPACK_IMPORTED_MODULE_4__.Hub.dispatch(_constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.U, {
        event: _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.a,
...
var composePhoneNumberInput = function (phoneNumber) {
    if (!phoneNumber.phoneNumberValue) {
        throw new Error(_constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.P);
    }
...
var checkUsernameAlias = function (usernameAlias) {
    if (!(usernameAlias in _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_0__.U)) {
        throw new Error("Invalid username Alias - " + usernameAlias + ". Instead use " + Object.values(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_0__.U));
    }
};
var onAuthUIStateChange = function (authStateHandler) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = payload.event;
                    switch (_a) {
                        case _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.a: return [3 /*break*/, 1];
                    }
                    return [3 /*break*/, 8];
                case 1:
                    if (!payload.message) return [3 /*break*/, 7];
                    if (!(payload.message === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_0__.A.SignedIn)) return [3 /*break*/, 6];
                    _b.label = 2;
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_6__.default.currentAuthenticatedUser()];
                case 3:
                    user = _b.sent();
    ...
    _aws_amplify_core__WEBPACK_IMPORTED_MODULE_4__.Hub.listen(_constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.U, authUIStateHandler);
    return function () { return _aws_amplify_core__WEBPACK_IMPORTED_MODULE_4__.Hub.remove(_constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.U, authUIStateHandler); };
};
...
var getRequiredAttributesMap = function () { return ({
    address: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.ADDRESS_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.ADDRESS_PLACEHOLDER),
    },
    nickname: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.NICKNAME_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.NICKNAME_PLACEHOLDER),
    },
    birthdate: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.BIRTHDATE_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.BIRTHDATE_PLACEHOLDER),
    },
    phone_number: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.PHONE_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.PHONE_PLACEHOLDER),
    },
    email: {
        lable: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.EMAIL_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.EMAIL_PLACEHOLDER),
    },
    picture: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.PICTURE_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.PICTURE_PLACEHOLDER),
    },
    family_name: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.FAMILY_NAME_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.FAMILY_NAME_PLACEHOLDER),
    },
    preferred_username: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.PREFERRED_USERNAME_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.PREFERRED_USERNAME_PLACEHOLDER),
    },
    gender: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.GENDER_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.GENDER_PLACEHOLDER),
    },
    profile: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.PROFILE_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.PROFILE_PLACEHOLDER),
    },
    given_name: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.GIVEN_NAME_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.GIVEN_NAME_PLACEHOLDER),
    },
    zoneinfo: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.ZONEINFO_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.ZONEINFO_PLACEHOLDER),
    },
    locale: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.LOCALE_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.LOCALE_PLACEHOLDER),
    },
    updated_at: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.UPDATED_AT_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.UPDATED_AT_PLACEHOLDER),
    },
    middle_name: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.MIDDLE_NAME_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.MIDDLE_NAME_PLACEHOLDER),
    },
    website: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.WEBSITE_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.WEBSITE_PLACEHOLDER),
    },
    name: {
        label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.NAME_LABEL),
        placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_5__.I18n.get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_1__.T.NAME_PLACEHOLDER),
    },
}); };
function handlePhoneNumberChange(event, phoneNumber) {
     ...
     * them together.
     */
    if (name === _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.C) {
        phoneNumber.countryDialCodeValue = value;
    }
    if (name === _constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_2__.b) {
...
;
//# sourceMappingURL=vendors-node_modules_aws-amplify_ui-components_dist_esm-es5_helpers-82822fb2_js.render-page.js.map