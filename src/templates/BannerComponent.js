  ...
  return (
    ...
    <div className="container-fluid">
      <div className="col-6 col-sm-7 justify-content-md-start">
        ...
        <h1 className="display-5 font-weight-bold pt-3 text-start proximamente">¡Próximamente!</h1>
        <AnchorLink to="/#somos">
        <button type="button" className="btnSomos btn btn-lg text-white">¿Quiénes somos?</button>
        </AnchorLink>
      </div>
    </div>
  </header>
