...
export default function Footer() {
    ...
    <div className="font-small pt-4 footer">
      <div fluid className="text-center text-md-left">
        <div className="row">
          <div className="col-6">
            <h5 className="title font-weight-bold text-white atrevete_footer">Atrévete a conocer RUTALAB</h5>
            <p className="text-white descripcion_footer">
              Servicios de test de laboratorio con los estándares más altos de calidad.
            </p>
          </div>
          <div className="col-6 text-center">
            ...
            <AnchorLink to="/#funciona">
              <li className="list-unstyled">
                <small href="#!" className="text-white">¿Cómo funciona?</small>
              </li>
            </AnchorLink>
            </ul>
          </div>
