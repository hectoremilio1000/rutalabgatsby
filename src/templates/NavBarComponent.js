...
return(
    ...
    <nav className="navbar navbar-expand-lg navbar-expand-md navbar-expand-xs navbar-light bg-light" id="home">
      <div className="col-lg-10 col-sm-6 col-6 col-md-10">
        <AnchorLink to="/#home" title="Our team" className="navbar-brand">
            <img src={imagenLogo} width="50" alt="Rutalab" className="imagen_logo"/>
            <img src={nombreLogo} alt="laboratorio" width="150" className="nombre_logo"/>
        </AnchorLink>
      </div>
